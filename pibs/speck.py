...
class SpeckCipher(object):
    ...
    def __init__(self, key, key_size=128, block_size=128, mode='ECB', init=0, counter=0, number_rounds=None):
        ...
        try:
            self.rounds = number_rounds#self.possible_setups[key_size]
    ...
    def encrypt(self, plaintext):
        ...
        if self.mode == 'ECB':
            b, a, KKK = self.encrypt_function(b, a)
...
if __name__ == "__main__":
    cipher = SpeckCipher(0x1f1e1d1c1b1a1918, 64, 32, mode='ECB')
    g = cipher.encrypt(0x65736f68)
    print(hex(g))
